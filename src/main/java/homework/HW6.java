...
Всю домашнюю работу нужно выполнять в старом проекте (без Maven).
В пакете homework создать класс HW6, всю работу выполнять в этом классе.
...
Все задачи решаются if-else and for. Если возможно, нужно использовать только один цикл for для решения одной задачи.
[1, 10] - означает, что 1 и 10 включительно
(1, 10] - означает что 1 исключительно, и 10 включительно
Если нет специального указания, то задачи тестировать не надо
...
11. Написать метод, который принимает на вход параметры n и m типа char, и выводит на печать последовательность букв
английского алфавита в промежутке между значениями n и m включительно.


Part 2
___________________________________________________

12. Написать метод, который принимает параметр и печатает последовательность четных чисел от нуля. Длина последовательности = l.
...
Метод формирует строку из сгенерированных значений, и выводит результат единожды на печать. Пpотестировать этот метод.
...
17. Написать метод, который принимает параметры n, m, l, и печатает последовательность нечетных чисел,  начиная с числа n,
с шагом m, длина последовательности l.

18. Написать метод, который принимает на вход параметры n, m, l и генерирует последовательность случайных целых чисел
в промежутке от n до m включительно. Длина последовательности - l. Вывести результат на печать

19. Сгенерируйте и распечатайте последовательность чисел, где для каждого положительного или отрицательного значения n
выводится на печать значение, рассчитанное по формуле:
Note - missing image
Для n = 0 и невалидных ситуаций  выводится значение 0

20. Написать метод, который принимает параметры l, n, и печатает последовательность чисел по формуле
Note - missing image
Длина последовательности l.

21. Сгенерируйте последовательность целых положительных  двузначных чисел, в которых разница между первой цифрой (десятки)
и второй цифрой (единицы) не превышает 3.

22. Написать метод, который вычислит значение функции:
Note - missing image

23. Написать метод, который генерирует последовательность простых положительных чисел и выводит последовательность на печать

24. Написать метод, который принимает на вход параметры day = “Sun”, month = 10, date = 2, и выводит на печать  последовательность:
Sun, Oct 02
Mon, Oct 03
Tue, Oct 04
Wed, Oct 05
